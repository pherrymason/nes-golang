...
; Preserved: A, X, Y
wait_vbl:
	bit PPUSTATUS			; // Reading from status, clears VBlank flag.
:       bit PPUSTATUS		; // This read from status also clears vBlank, but as the value is stored in A, we can test it
	bpl :-
:       rts
